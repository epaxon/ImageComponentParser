classdef ImageComponentParser < hgsetget
    ...
    methods
        ...
        function self = init_gui(self, parent)
            ...
            set(self.h.thresh_slider, 'Min', 0, 'Max', 1);
        ...
        function default_settings(self)
            ...
            self.data(self.gui.current_trial).settings.ica.which_pcs = 1:50;
            ...
            self.data(self.gui.current_trial).settings.segment.down_size = 4;
            self.data(self.gui.current_trial).settings.segment.thresh = 0.5;
